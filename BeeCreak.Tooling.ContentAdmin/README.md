...
A lightweight Electron desktop helper that makes it easy to browse and edit the text based assets that live in `BeeCreak.Client/BeeCreak.Client.App/Content`.

## Getting started

```bash
cd BeeCreak.Tooling.ContentAdmin
npm install
npm start
```

The app automatically points at `../BeeCreak.Client/BeeCreak.Client.App/Content` relative to this folder. No extra configuration is required as long as the Tooling project stays inside the BeeCreak repo.
