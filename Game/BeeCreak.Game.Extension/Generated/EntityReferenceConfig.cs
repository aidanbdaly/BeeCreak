...
{
    public const string FileExtension = ".eref";

    public const string ImporterDisplayName = "EntityReference Importer";

    public const string ProcessorDisplayName = "EntityReference Processor";
