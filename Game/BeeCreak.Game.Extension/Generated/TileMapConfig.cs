...
{
    public const string FileExtension = ".tref";

    public const string ImporterDisplayName = "TileMap Importer";

    public const string ProcessorDisplayName = "TileMap Processor";
