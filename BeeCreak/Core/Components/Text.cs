...
{
    public class Text(string text, Asset<SpriteFont> fontAsset, int? maxWidth = null) : Renderable
    {
        private readonly Asset<SpriteFont> fontAsset = fontAsset;

        private readonly string renderedText = PrepareText(text ?? string.Empty, fontAsset.Value, maxWidth);

        public override Rectangle GetBounds()
        {
            var size = fontAsset.Value.MeasureString(renderedText) * Scale;
